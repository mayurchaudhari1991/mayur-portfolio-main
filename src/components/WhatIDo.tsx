        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                From SPAs to component-based architectures, I deliver
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing robust APIs and microservices. From recruitment
                platforms to distributed systems, I build backends that scale
                reliably under load.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
